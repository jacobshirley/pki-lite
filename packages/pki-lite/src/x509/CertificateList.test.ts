...
describe('CertificateList', () => {
    ...
    test('CertificateList toPem snapshot', () => {
        ...
        expect(obj.toPem()).toMatchInlineSnapshot(`
          "-----BEGIN X509 CRL-----
          
          -----END X509 CRL-----"
        `)
    })
})
