...
describe('TBSCertList', () => {
    ...
    test('TBSCertList toPem snapshot with revoked certificates and extensions', () => {
        ...
        expect(obj.toPem()).toMatchInlineSnapshot(`
          "-----BEGIN TBSCERTLIST-----
          MIGGAgEBMAsGCSqGSIb3DQEBCzAuMRAwDgYDVQQDEwdUZXN0IENBMRowGAYDVQQKExFUZXN0IE9yZ2FuaXphdGlvbhcNMjUwMTAxMDAwMDAwWhcNMjYwMTAxMDAwMDAwWjAVMBMCAjA5Fw0yNTA2MDEwMDAwMDBaoA8wDTALBgNVHRQEBAQCAQA=
          -----END TBSCERTLIST-----"
        `)
    })
})
