...
describe('SafeBag', () => {
    it('encodes and decodes a SafeBag with CertBag value', () => {
        ...
        expect(decoded.bagId.value).toEqual(bagId)
...
describe('SafeContents', () => {
    it('encodes and decodes a sequence of SafeBag', () => {
        ...
        expect(decoded[0].bagId.value).toEqual('1.2.840.113549.1.9.22.1')
        expect(decoded[1].bagId.value).toEqual('1.2.840.113549.1.9.22.2')
    })
})
