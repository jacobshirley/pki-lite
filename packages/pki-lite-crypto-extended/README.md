...
Extends `WebCryptoProvider` from `pki-lite`.

#### Methods

##### `digest(data: Uint8Array, algorithm: HashAlgorithm): Promise<Uint8Array>`

Computes hash digests with support for MD5.

- **data**: Data to hash
- **algorithm**: Hash algorithm (`'MD5'`, `'SHA-256'`, etc.)
- **Returns**: Hash digest as Uint8Array

##### `encryptSymmetric(data: Uint8Array, key: Uint8Array, algorithm: SymmetricEncryptionAlgorithmParams): Promise<Uint8Array>`

Encrypts data with extended AES support.

- **data**: Plaintext data
- **key**: Encryption key
- **algorithm**: Encryption algorithm parameters
- **Returns**: Ciphertext as Uint8Array

##### `decryptSymmetric(data: Uint8Array, key: Uint8Array, algorithm: SymmetricEncryptionAlgorithmParams): Promise<Uint8Array>`

Decrypts data with extended AES support.

- **data**: Ciphertext data
- **key**: Decryption key
- **algorithm**: Decryption algorithm parameters
