...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [pkcs12/DigestInfo](../README.md) / DigestInfo
...
- [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`DigestInfo`\>

## Constructors

### Constructor

> **new DigestInfo**(`options`): `DigestInfo`
...
> **digest**: [`OctetString`](../../../asn1/OctetString/classes/OctetString.md)
...
> `static` **fromAsn1**(`asn1`): `DigestInfo`
