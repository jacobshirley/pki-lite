...
Re-exports [hexBytesToBytes](PkiBase/functions/hexBytesToBytes.md)
...
Re-exports [PolicyValidationResult](CertificateValidator/interfaces/PolicyValidationResult.md)
