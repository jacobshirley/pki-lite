...
[PKI-Lite](../../../../../../README.md) / [pki-lite](../../../../../README.md) / [core/PkiBase](../../../README.md) / [asn1js](../README.md) / Null

# Class: Null

## Extends

- [`BaseBlock`](BaseBlock.md)\<[`ValueBlock`](ValueBlock.md), [`ValueBlockJson`](../type-aliases/ValueBlockJson.md)\>

## Constructors

### Constructor

> **new Null**(`parameters?`): `Null`
...
> **valueBlock**: [`ValueBlock`](ValueBlock.md)
...
> **toJSON**(): [`BaseBlockJson`](../interfaces/BaseBlockJson.md)\<`LocalBaseBlockJson`\>

Returns a JSON representation of an object

#### Returns

[`BaseBlockJson`](../interfaces/BaseBlockJson.md)\<`LocalBaseBlockJson`\>
