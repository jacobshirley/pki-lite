...
[PKI-Lite](../../../../../../README.md) / [pki-lite](../../../../../README.md) / [core/PkiBase](../../../README.md) / [asn1js](../README.md) / OctetString

# Class: OctetString

## Extends

- [`BaseBlock`](BaseBlock.md)\<`LocalOctetStringValueBlock`, `LocalOctetStringValueBlockJson`\>

## Constructors

### Constructor

> **new OctetString**(`__namedParameters?`): `OctetString`
...
> **toJSON**(): [`BaseBlockJson`](../interfaces/BaseBlockJson.md)\<`LocalOctetStringValueBlockJson`\>

Returns a JSON representation of an object

#### Returns

[`BaseBlockJson`](../interfaces/BaseBlockJson.md)\<`LocalOctetStringValueBlockJson`\>
