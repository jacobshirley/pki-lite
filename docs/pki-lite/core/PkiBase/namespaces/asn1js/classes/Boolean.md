...
[PKI-Lite](../../../../../../README.md) / [pki-lite](../../../../../README.md) / [core/PkiBase](../../../README.md) / [asn1js](../README.md) / Boolean

# Class: Boolean

## Extends

- [`BaseBlock`](BaseBlock.md)\<`LocalBooleanValueBlock`, `LocalBooleanValueBlockJson`\>

## Constructors

### Constructor

> **new Boolean**(`parameters?`): `Boolean`
...
> **valueBlock**: `LocalBooleanValueBlock`
...
> **isEqual**(`other`): `other is Boolean`
...
> **toJSON**(): [`BaseBlockJson`](../interfaces/BaseBlockJson.md)\<`LocalBooleanValueBlockJson`\>

Returns a JSON representation of an object

#### Returns

[`BaseBlockJson`](../interfaces/BaseBlockJson.md)\<`LocalBooleanValueBlockJson`\>
