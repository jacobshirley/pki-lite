...
[PKI-Lite](../../../../../../README.md) / [pki-lite](../../../../../README.md) / [core/PkiBase](../../../README.md) / [asn1js](../README.md) / Primitive

# Class: Primitive

## Extends

- [`BaseBlock`](BaseBlock.md)\<`LocalPrimitiveValueBlock`, `LocalPrimitiveValueBlockJson`\>
...
> **toJSON**(): [`BaseBlockJson`](../interfaces/BaseBlockJson.md)\<`LocalPrimitiveValueBlockJson`\>

Returns a JSON representation of an object

#### Returns

[`BaseBlockJson`](../interfaces/BaseBlockJson.md)\<`LocalPrimitiveValueBlockJson`\>
