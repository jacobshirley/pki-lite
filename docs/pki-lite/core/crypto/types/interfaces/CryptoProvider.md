...
> **digest**(`data`, `hash`): `Promise`\<`Uint8Array`\<`ArrayBuffer`\>\>
...
> **digestAlgorithm**(`algorithm`): `Uint8Array`\<`ArrayBuffer`\> \| [`AlgorithmIdentifier`](../../../../algorithms/AlgorithmIdentifier/classes/AlgorithmIdentifier.md)
...
`Uint8Array`\<`ArrayBuffer`\> \| [`AlgorithmIdentifier`](../../../../algorithms/AlgorithmIdentifier/classes/AlgorithmIdentifier.md)
...
> **getEcCurveParameters**(`algorithm`): `Uint8Array`\<`ArrayBuffer`\> \| [`ObjectIdentifier`](../../../../asn1/ObjectIdentifier/classes/ObjectIdentifier.md)
...
`Uint8Array`\<`ArrayBuffer`\> \| [`ObjectIdentifier`](../../../../asn1/ObjectIdentifier/classes/ObjectIdentifier.md)
...
> **signatureAlgorithm**(`algorithm`): `Uint8Array`\<`ArrayBuffer`\> \| [`AlgorithmIdentifier`](../../../../algorithms/AlgorithmIdentifier/classes/AlgorithmIdentifier.md)
