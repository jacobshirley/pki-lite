...
[PKI-Lite](../../../../../README.md) / [pki-lite](../../../../README.md) / [pkcs7/recipients/OriginatorInfo](../README.md) / OriginatorInfo
...
- [`PkiBase`](../../../../core/PkiBase/classes/PkiBase.md)\<`OriginatorInfo`\>

## Constructors

### Constructor

> **new OriginatorInfo**(`options`): `OriginatorInfo`
...
> `optional` **certs**: [`CertificateSet`](../../../../x509/CertificateSet/classes/CertificateSet.md)
...
> `static` **fromAsn1**(`asn1`): `OriginatorInfo`
