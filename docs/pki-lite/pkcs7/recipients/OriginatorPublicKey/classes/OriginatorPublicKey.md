...
[PKI-Lite](../../../../../README.md) / [pki-lite](../../../../README.md) / [pkcs7/recipients/OriginatorPublicKey](../README.md) / OriginatorPublicKey
...
- [`PkiBase`](../../../../core/PkiBase/classes/PkiBase.md)\<`OriginatorPublicKey`\>

## Constructors

### Constructor

> **new OriginatorPublicKey**(`options`): `OriginatorPublicKey`
...
> `static` **fromAsn1**(`asn1`): `OriginatorPublicKey`
