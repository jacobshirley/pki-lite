...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [pkcs7/EncryptedData](../README.md) / EncryptedData
...
- [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`EncryptedData`\>

## Constructors

### Constructor

> **new EncryptedData**(`options`): `EncryptedData`
...
> `static` **fromAsn1**(`asn1`): `EncryptedData`
