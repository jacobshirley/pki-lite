...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [ocsp/OCSPSignature](../README.md) / OCSPSignature
...
- [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`OCSPSignature`\>

## Constructors

### Constructor

> **new OCSPSignature**(`options`): `OCSPSignature`
...
> `static` **fromAsn1**(`asn1`): `OCSPSignature`
...
> `static` **fromDer**(`der`): `OCSPSignature`
