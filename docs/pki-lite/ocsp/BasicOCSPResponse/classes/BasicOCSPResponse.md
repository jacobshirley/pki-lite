...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [ocsp/BasicOCSPResponse](../README.md) / BasicOCSPResponse
...
- [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`BasicOCSPResponse`\>

## Constructors

### Constructor

> **new BasicOCSPResponse**(`options`): `BasicOCSPResponse`
...
[`ResponseData`](../../ResponseData/classes/ResponseData.md)
...
> `optional` **certs**: [`Certificate`](../../../x509/Certificate/classes/Certificate.md)[]
...
> **tbsResponseData**: [`ResponseData`](../../ResponseData/classes/ResponseData.md)
...
> `static` **fromAsn1**(`asn1`): `BasicOCSPResponse`
