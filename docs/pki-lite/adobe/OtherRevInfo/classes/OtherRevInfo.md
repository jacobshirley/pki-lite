...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [adobe/OtherRevInfo](../README.md) / OtherRevInfo
...
- [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`OtherRevInfo`\>

## Constructors

### Constructor

> **new OtherRevInfo**(`options`): `OtherRevInfo`
...
> `static` **fromAsn1**(`asn1`): `OtherRevInfo`
