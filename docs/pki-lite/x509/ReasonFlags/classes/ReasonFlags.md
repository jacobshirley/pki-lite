...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [x509/ReasonFlags](../README.md) / ReasonFlags
...
- [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`ReasonFlags`\>

## Constructors

### Constructor

> **new ReasonFlags**(`options?`): `ReasonFlags`
...
> `static` **fromAsn1**(`asn1`): `ReasonFlags`
