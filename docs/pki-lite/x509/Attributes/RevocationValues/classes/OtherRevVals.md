...
[PKI-Lite](../../../../../README.md) / [pki-lite](../../../../README.md) / [x509/attributes/RevocationValues](../README.md) / OtherRevVals
...
- [`PkiBase`](../../../../core/PkiBase/classes/PkiBase.md)\<`OtherRevVals`\>

## Constructors

### Constructor

> **new OtherRevVals**(`options`): `OtherRevVals`
...
> **OtherRevVals**: [`Any`](../../../../asn1/Any/classes/Any.md)

---

### OtherRevValType

> **OtherRevValType**: [`ObjectIdentifier`](../../../../asn1/ObjectIdentifier/classes/ObjectIdentifier.md)
...
> `static` **fromAsn1**(`asn1`): `OtherRevVals`
