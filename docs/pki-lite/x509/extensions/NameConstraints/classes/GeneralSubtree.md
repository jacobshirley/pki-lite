...
[PKI-Lite](../../../../../README.md) / [pki-lite](../../../../README.md) / [x509/extensions/NameConstraints](../README.md) / GeneralSubtree
...
- [`PkiBase`](../../../../core/PkiBase/classes/PkiBase.md)\<`GeneralSubtree`\>

## Constructors

### Constructor

> **new GeneralSubtree**(`options`): `GeneralSubtree`
...
> **base**: [`GeneralName`](../../../GeneralName/type-aliases/GeneralName.md)
...
`string` | [`RDNSequence`](../../../RDNSequence/classes/RDNSequence.md) | [`GeneralName`](../../../GeneralName/type-aliases/GeneralName.md) | \{ `toString`: () => `string`; \}
