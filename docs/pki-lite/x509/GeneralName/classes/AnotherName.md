...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [x509/GeneralName](../README.md) / AnotherName
...
- [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`AnotherName`\>
...
> **new AnotherName**(`options`): `AnotherName`
...
> `static` **fromAsn1**(`asn1`): `AnotherName`
