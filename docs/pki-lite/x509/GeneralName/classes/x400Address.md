...
`null` \| `string` \| `number` \| `boolean` \| [`Asn1BaseBlock`](../../../core/PkiBase/type-aliases/Asn1BaseBlock.md) \| `ArrayBuffer` \| `Uint8Array`\<`ArrayBuffer`\> \| [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`any`\> \| [`Any`](../../../asn1/Any/classes/Any.md)
