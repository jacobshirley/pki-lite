...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [x509/PolicyInformation](../README.md) / PolicyQualifierInfo
...
- [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`PolicyQualifierInfo`\>

## Constructors

### Constructor

> **new PolicyQualifierInfo**(`options`): `PolicyQualifierInfo`
...
> **policyQualifierId**: [`ObjectIdentifier`](../../../asn1/ObjectIdentifier/classes/ObjectIdentifier.md)

---

### qualifier

> **qualifier**: [`Any`](../../../asn1/Any/classes/Any.md)
...
> `static` **fromAsn1**(`asn1`): `PolicyQualifierInfo`
