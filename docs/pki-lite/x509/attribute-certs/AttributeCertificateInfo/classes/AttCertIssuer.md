...
[PKI-Lite](../../../../../README.md) / [pki-lite](../../../../README.md) / [x509/attribute-certs/AttributeCertificateInfo](../README.md) / AttCertIssuer
...
- [`PkiBase`](../../../../core/PkiBase/classes/PkiBase.md)\<`AttCertIssuer`\>

## Constructors

### Constructor

> **new AttCertIssuer**(`options`): `AttCertIssuer`
...
Configuration options for the issuer
...
> `static` **fromAsn1**(`asn1`): `AttCertIssuer`
