...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [keys/RSAPublicKey](../README.md) / RSAPublicKey
...
- [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`RSAPublicKey`\>

## Constructors

### Constructor

> **new RSAPublicKey**(`options`): `RSAPublicKey`
...
> `static` **fromAsn1**(`asn1`): `RSAPublicKey`
...
A new RSAPublicKey instance

---

### fromDer()

> `static` **fromDer**(`der`): `RSAPublicKey`
...
> `static` **fromPem**(`pem`): `RSAPublicKey`
