...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [algorithms/AlgorithmIdentifier](../README.md) / KeyEncryptionAlgorithmIdentifier

# Class: KeyEncryptionAlgorithmIdentifier
...
> **new KeyEncryptionAlgorithmIdentifier**(`options`): `KeyEncryptionAlgorithmIdentifier`
...
> **decrypt**(`data`, `privateKeyInfo`): `Promise`\<`Uint8Array`\<`ArrayBufferLike`\>\>
...
> **encrypt**(`data`, `publicKeyInfo`): `Promise`\<`Uint8Array`\<`ArrayBufferLike`\>\>
...
> `static` **fromAsn1**(`asn1`): `KeyEncryptionAlgorithmIdentifier`
...
> `static` **fromDer**(`bytes`): `KeyEncryptionAlgorithmIdentifier`
...
> `static` **keyEncryptionAlgorithm**(`encryptionParams`): `KeyEncryptionAlgorithmIdentifier`
