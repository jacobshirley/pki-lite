...
> **decrypt**(`data`, `key`): `Promise`\<`Uint8Array`\<`ArrayBufferLike`\>\>
...
> **encrypt**(`data`, `key`): `Promise`\<`Uint8Array`\<`ArrayBufferLike`\>\>
...
> `static` **fromDer**(`bytes`): `ContentEncryptionAlgorithmIdentifier`
