...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [algorithms/CCMParameters](../README.md) / CCMParameters
...
- [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`CCMParameters`\>

## Constructors

### Constructor

> **new CCMParameters**(`options`): `CCMParameters`
...
The ASN.1 representation of the CCMParameters
...
> `static` **fromAsn1**(`asn1`): `CCMParameters`
