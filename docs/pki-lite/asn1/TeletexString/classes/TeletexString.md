...
[PKI-Lite](../../../../README.md) / [pki-lite](../../../README.md) / [asn1/TeletexString](../README.md) / TeletexString
...
- [`PkiBase`](../../../core/PkiBase/classes/PkiBase.md)\<`TeletexString`\>

## Constructors

### Constructor

> **new TeletexString**(`options`): `TeletexString`
...
`string` \| `Uint8Array`\<`ArrayBufferLike`\> \| `TeletexString`
...
> `static` **fromAsn1**(`asn1`): `TeletexString`
