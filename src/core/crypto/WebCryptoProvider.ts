...
export class WebCryptoProvider implements CryptoProvider {
    // Add crypto property for testing
    ...
    toDerivationAlgorithmParams(
        ...
        switch (algorithm.algorithm.toString()) {
            ...
            default:
                throw new UnsupportedCryptoAlgorithm(
                    `Unsupported key derivation algorithm: ${algorithm.commonAlgorithmName}`,
                )
        }
    }
    ...
    toPbeAlgorithmParams(algorithm: AlgorithmIdentifier): PbeAlgorithmParams {
        switch (algorithm.algorithm.toString()) {
            ...
            default:
                throw new UnsupportedCryptoAlgorithm(
                    `Unsupported PBE algorithm: ${algorithm.commonAlgorithmName}`,
                )
        }
    }
    ...
    toSymmetricEncryptionAlgorithmParams(
        ...
        switch (algorithm.algorithm.toString()) {
            ...
            default:
                throw new UnsupportedCryptoAlgorithm(
                    `Unsupported symmetric encryption algorithm: ${algorithm.commonAlgorithmName}`,
                )
        }
    }
    ...
    toAsymmetricEncryptionAlgorithmParams(
        ...
        switch (algorithm.algorithm.value) {
            ...
            default:
                throw new UnsupportedCryptoAlgorithm(
                    `Unsupported algorithm: ${algorithm.commonAlgorithmName}`,
                )
        }
    }
    ...
    toHashAlgorithm(algorithm: AlgorithmIdentifier): HashAlgorithm {
        switch (algorithm.algorithm.value) {
            ...
            default:
                throw new UnsupportedCryptoAlgorithm(
                    `Unsupported hash algorithm: ${algorithm.commonAlgorithmName}`,
                )
        }
    }
}
